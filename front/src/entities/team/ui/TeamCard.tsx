...
import { useLeaveTeamMutation } from "../api/hooks/useLeaveTeamMutation";
...
export const TeamCard = ({ image, name, uid }: ITeamCardProps) => {
  ...
  const { mutateAsync, isPending } = useLeaveTeamMutation();

  const leaveTeam = async () => {
    await mutateAsync({ params: { teamUid: uid } });
    setOpen(false);
  };
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent aria-describedby={undefined}>
            ...
            <div className='flex items-center justify-end gap-2'>
              ...
              <Button disabled={isPending} onClick={leaveTeam}>
